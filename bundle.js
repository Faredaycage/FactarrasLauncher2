    ...
    (function(r) {
        ...
        return p(p.s = 0)
            ...
            const Ra = (() => {
                        ...
                        if (!b.hideGui) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    } else W[6].draw("Factarras Arras", h + 200, m - 42 - 2, 15, l.guiwhite, "right");
                ...
                Ta = (() => {
                    ...
                    let x = () => {
                            ...
                            if (0 === c) return d + "Not even one kill?";
                            c = [];
                            a[0] && c.push(a[0] + " kills");
                            a[1] && c.push(a[1] + " assists");
                            a[2] && c.push(a[2] + " bosses defeated");
                            return d +
                                c.join(" and ")
                        },
            ...
            const Sa = (() => {
                    ...
                    m();
                    var c = [
                        ["The game is in Active Beta, Join our discord"
            ...
            const e = {
                ...
                servers: [{
                    ...
                    id: "a",
                    type: "3tdm",
                    code: "Factarras-Arras.io",
                    at: p.heroku("factarras"),
                },].map((a, e) => ({
                    data: a,
                    i: e
